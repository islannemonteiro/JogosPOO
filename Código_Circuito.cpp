	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE TERCEIRO NUMERO DO CODIGO NO TERMINAL> "; //RESPOSTA
			cin >> codigo;
			if (codigo == num3) cod3 = true;	
			
			cout << "<DIGITE QUARTO NUMERO DO CODIGO NO TERMINAL> "; //RESPOSTA
			cin >> codigo;
	...
	int contador;
	for ( contador = 0; contador <= 3; contador++ ) // RESPOSTA
	{
		cout << (" ") << endl; 
	} 
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// O IF ELSE executa as condições postas dentro do parêtese. SE a condição for "true" o programa é executado e os comandos são obedecidos pelo compilador. //RESPOSTA
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
